...
class BaseAdminController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $view->setData(['activeLang' => $this->activeLang, 'activeLanguages' => $this->activeLanguages, 'generalSettings' => $this->generalSettings, 'baseSettings' => $this->settings, 'baseCategories' => $this->categories]);
    }
}
