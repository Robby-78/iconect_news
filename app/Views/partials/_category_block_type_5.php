    ...
    <div class="row">
        <section class="section">
            <div class="section-head" style="border-bottom: 2px solid <?= esc($category->color); ?>;">
                ...
                <?= view('partials/_block_subcategories', ['category' => $category, 'subCategories' => $subCategories]); ?>
            </div>
                                    ...
                                    if ($i < 4):
                                                    ...
                                                    <?php if (checkPostImg($post)): ?>
                                                        <div class="post-item-image">
                                                            <a href="<?= generatePostURL($post); ?>"<?php postURLNewTab($post); ?>>
                                                                <?= view("post/_post_image", ["postItem" => $post, "type" => "big"]); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="col-sm-4 col-xs-12">
                                                <?= view("post/_post_item_mid", ["post" => $post]); ?>
                                            </div>
                                        <?php endif;
                                    endif;
                                    $i++;
