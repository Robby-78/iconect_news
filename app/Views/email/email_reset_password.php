                        ...
                        <td>
                            ...
                            <div class="mailcontent" style="line-height: 26px;font-size: 14px;">
                                ...
                                <p style='text-align: center;margin-top: 30px;'>
                                    <a href="<?= generateURL('reset_password'); ?>?token=<?= $token; ?>" style='font-size: 14px;text-decoration: none;padding: 14px 40px;background-color: #1abc9c;color: #ffffff !important; border-radius: 3px;'>
