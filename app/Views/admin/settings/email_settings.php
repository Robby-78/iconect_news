                    ...
                    <?php if ($protocol == "smtp"): ?>
                        <div class="form-group">
                            ...
                            <select name="mail_library" class="form-control">
                                <option value="swift" <?= $generalSettings->mail_library == "swift" ? "selected" : ""; ?>>Swift Mailer</option>
                                <option value="php" <?= $generalSettings->mail_library == "php" ? "selected" : ""; ?>>PHP Mailer</option>
                            </select>
                        </div>
                    <?php else: ?>
                ...
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12 col-option">
                                <input type="radio" name="email_verification" value="0" id="email_verification_2" class="square-purple" <?= $generalSettings->email_verification == '0' ? 'checked' : ''; ?>>
                ...
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12 col-option">
                                <input type="radio" name="mail_contact_status" value="0" id="mail_contact_status_2" class="square-purple" <?= $generalSettings->mail_contact_status == '0' ? 'checked' : ''; ?>>
