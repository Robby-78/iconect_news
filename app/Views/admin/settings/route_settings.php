            ...
            <form action="<?= base_url('AdminController/routeSettingsPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="visual_settings_readonly" value="visual_settings" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="visual_settings" value="<?= $routes->visual_settings; ?>" maxlength="100" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
